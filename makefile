...
tx-test:
	iverilog -g2012 -o behaivoral_tests/uart_tx_tb/tx_test.vvp  behaivoral_tests/uart_tx_tb/uart_tx_tb.sv uart_tx.v baud_gen.v
	vvp -n behaivoral_tests/uart_tx_tb/tx_test.vvp
